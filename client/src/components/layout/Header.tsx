...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navigationItems = [
    ...
    { label: 'Memories', href: '/memories', active: false, icon: '��' },
    { label: 'Friends', href: '/friends', active: false, icon: '🧑‍🤝‍🧑' },
    { label: 'Explore', href: '/explore', active: false, icon: '🌟' },
  ];
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search memories, batches, or people..."
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                    <div className="py-1">
                      ...
                      <a href="/help" className="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Help</a>
                      <button
                        onClick={onSignOut}
